              ...
              <FormControl>
                ...
                {!/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/.test(
                  ...
                  <FormHelperText color={"red.300"} mb={5}>
                    {manifest[language].signUp.rows.warning1}
                    <br />
                    {manifest[language].signUp.rows.warning2}
                    <br />
                    {manifest[language].signUp.rows.warning3}
                    <br />
                    {manifest[language].signUp.rows.warning4}
                    <br />
                    {manifest[language].signUp.rows.warning5}
                    <br />
                  </FormHelperText>
                ) : (
                  <span />
